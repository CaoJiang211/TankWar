...
public class Tank {
	...
	void move() {
		...
		if(x < 0) x = 0;
		if(y < 30) y = 30;
		if(x + Tank.WIDTH > TankClient.GAME_WIDTH ) x = TankClient.GAME_WIDTH 
				- Tank .WIDTH;
		if(y + Tank.HEIGHT > TankClient.GAME_HEIGHT) y = TankClient.GAME_HEIGHT 
				- Tank.HEIGHT;
	...
	public Rectangle getRect(){
		return new Rectangle(x, y, tankImages[0].getWidth(null),
				tankImages[0].getHeight(null));
	}
	...
	private class BloodBar{
		public void draw(Graphics g) {
			...
			g.drawRect(x+8, y-10, WIDTH, 10);
			int w = WIDTH * life/100;
			g.fillRect(x+8, y-10, w, 10);
			g.setColor(c);
		}
	}
